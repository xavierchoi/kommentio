...
Now, proceed to code test the tasks that users have requested or are currently working on. If the user's explanation is lacking, ask them what they want you to check and resume testing based on that.